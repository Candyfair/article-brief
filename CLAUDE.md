...
- File/folder structure:
  ...
  - `/src/lib/word-count.ts` — shared word-count function used by both PasteArea's displayed count (SPEC.md §2.2) and the target-point calculation in prompts.ts, so the two never diverge
