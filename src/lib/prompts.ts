...
Lis attentivement l'article fourni ci-dessous. Rédige d'abord une phrase d'introduction courte et originale qui indique de quoi parle l'article, sans jamais reprendre son titre tel quel. Ne pas se contenter de réorganiser les mots de la première phrase de l'article : formuler cette introduction avec un vocabulaire et une construction différents de ceux du texte source. Le texte fourni peut être précédé de mentions de partage, légales, ou d'une URL avant le début réel de l'article : ignore ce type de contenu et repère où l'article commence réellement. Saute ensuite une ligne. Rédige enfin environ ${targetPoints} points reprenant les idées principales de l'article, en veillant à ce qu'ils couvrent l'ensemble du texte — son début, son développement et sa conclusion — plutôt que de te concentrer uniquement sur ses premières parties. Regroupe les idées proches sous un même point plutôt que d'en faire des points séparés : chaque point peut résumer plusieurs informations liées entre elles. Rédige un point par ligne, chaque ligne commençant par un tiret cadratin (—) suivi d'un espace.
...
Rappel : le texte ci-dessus peut contenir des mentions de partage, des mentions légales ou une URL avant le début réel de l'article — ignore-les entièrement. Respecte le format demandé : commence directement par une phrase d'introduction originale (jamais de titre ni de ligne d'en-tête séparée). Ne pas se contenter de réorganiser les mots de la première phrase de l'article : formuler cette introduction avec un vocabulaire et une construction différents de ceux du texte source. Puis une ligne vide, puis environ ${targetPoints} points qui couvrent l'article de bout en bout — y compris sa fin, pas seulement son début — en regroupant les idées proches sous un même point plutôt que d'en faire des points séparés, chaque point sur sa propre ligne commençant par un tiret cadratin (—).`;
}
